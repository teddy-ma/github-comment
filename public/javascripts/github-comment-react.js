...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.props.auth ? React.createElement(
	        'div',
	        null,
	        React.createElement('input', { onChange: this.handleChange, className: style.input, type: 'text', name: 'body', id: 'github-comment-default-input', placeholder: 'TODO: ' }),
	        React.createElement(
	          'button',
	...
	var App = React.createClass({
	  ...
	  detect_login: function detect_login() {
	    if (this.isMounted()) {
	      this.setState({
	        detect_login: true
	      });
	  ...
	  check_login: function check_login() {
	    $.ajax({
	      type: "POST",
	      dataType: "json",
	      contentType: "application/json; charset=utf-8",
	  ...
	  after_create_comment: function after_create_comment() {
	    $.get(comments_url, (function (result) {
	      if (this.isMounted()) {
	        this.setState({
	          comments: result
	...
	ReactDOM.render(React.createElement(App, null), document.getElementById("github-comments"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./node_modules/css-loader/index.js?modules!./node_modules/sass-loader/index.js?outputStyle=expanded!./app.scss", function() {
				var newContent = require("!!./node_modules/css-loader/index.js?modules!./node_modules/sass-loader/index.js?outputStyle=expanded!./app.scss");
